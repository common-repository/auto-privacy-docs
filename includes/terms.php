...
<h1 class='adsmax_privacydocs_page_h1'>Terms of Use</h1>
...
<p><strong>Website</strong> refers to " . get_site_url() . ", accessible from <a href='" . get_site_url() . "' rel='external nofollow noopener' target='_blank'>" . get_site_url() . "</a></p>
...
<div class="adsmax_privacydocs_buttonholder">
	<div class="adsmax_privacydocs_copyhtml adsmax_privacydocs_submit3" id="adsmax_privacydocs_createpage_terms">
...
<textarea id="adsmax_privacydocs_codebox" class="adsmax_privacydocs_code"><?php echo wp_kses_post($terms_html); ?></textarea>
