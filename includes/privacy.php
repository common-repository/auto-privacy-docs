...
<h1 class='adsmax_privacydocs_page_h1'>Privacy Policy</h1>
...
<strong>With other users:</strong> when You share personal information or otherwise interact in the public areas with other users, such information may be viewed by all users and may be publicly distributed outside.<br/>
...
<p>
By visiting this page on our website: <a href='" . get_site_url() . "/" . esc_html($company_contact) . "' rel='external nofollow noopener' target='_blank'>" . get_site_url() . "/" . esc_html($company_contact) . "</a><br/>
</p>
</div>
";
?>
<div class="adsmax_privacydocs_buttonholder">
	<div class="adsmax_privacydocs_copyhtml adsmax_privacydocs_submit3" id="adsmax_privacydocs_createpage_privacy">
...
<div class="adsmax_privacydocs_contentholder">
	<div id="adsmax_privacydocs_copy_text">
		<?php echo wp_kses_post($privacy_policy_html); ?>
	</div>
</div>
<div class="adsmax_privacydocs_htmldivider"></div>
<h1>HTML Code for this Page:</h1>
<textarea id="adsmax_privacydocs_codebox" class="adsmax_privacydocs_code"><?php echo wp_kses_post($privacy_policy_html); ?></textarea>
