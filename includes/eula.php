...
<h1 class='adsmax_privacydocs_page_h1'>EULA</h1>
<p>Please read this End-User License Agreement carefully before clicking the &quot;I Agree&quot; button, downloading or using " . get_site_url() . ".</p>
...
<p><strong>Application</strong> means the software program provided by the Company downloaded by You to a Device, named " . get_site_url() . "</p>

<p><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to " . esc_html($company_name) . ", " . esc_html($company_address) . ".</p>
...
<p><strong>Country</strong> refers to: " . esc_html($company_state) . ",  United States</p>
...
<p>The Company collects, stores, maintains, and shares information about You in accordance with Our Privacy Policy: <a href='" . get_site_url() . "/privacy' rel='external nofollow noopener' target='_blank'>" . get_site_url() . "/privacy</a></p>
...
<div class="adsmax_privacydocs_buttonholder">
	<div class="adsmax_privacydocs_copyhtml adsmax_privacydocs_submit3" id="adsmax_privacydocs_createpage_eula">
		Create EULA Page
	</div>
...
<div class="adsmax_privacydocs_contentholder">
	<div id="adsmax_privacydocs_copy_text">
		<?php echo wp_kses_post($eula_html); ?>
	</div>
</div>
<div class="adsmax_privacydocs_htmldivider"></div>
<h1>HTML Code for this Page:</h1>
<textarea id="adsmax_privacydocs_codebox" class="adsmax_privacydocs_code"><?php echo wp_kses_post($eula_html); ?></textarea>
